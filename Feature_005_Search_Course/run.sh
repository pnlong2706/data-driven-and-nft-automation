#!/usr/bin/env bash
# Run all Feature 005 (Search Course) automation suites.
...
run_level1() {
    ...
    echo "========================================================"
    "$PYTHON" -m unittest Level_1.test_level1_search_course -v || EXITCODE=1
}
...
run_level2() {
    ...
    echo "========================================================"
    "$PYTHON" -m unittest Level_2.test_level2_search_course -v || EXITCODE=1
}
...
run_nf() {
    ...
    echo "========================================================"
    "$PYTHON" -m unittest Non_Functional.test_non_functional_search_course -v || EXITCODE=1
}
