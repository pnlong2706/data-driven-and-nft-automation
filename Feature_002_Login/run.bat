@echo off
REM Run Feature 002 (Login) suites.
...
echo ========================================================
"%PYTHON%" -m unittest Level_1.test_level1_login -v
...
echo ========================================================
"%PYTHON%" -m unittest Level_2.test_level2_login -v
if errorlevel 1 set "EXITCODE=1"
exit /b 0
...
echo ========================================================
"%PYTHON%" -m unittest Non_Functional.test_non_functional_login -v
if errorlevel 1 set "EXITCODE=1"
exit /b 0
